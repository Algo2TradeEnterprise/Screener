                            ...
                            If stockData.ContainsKey(runningStock) AndAlso stockData(runningStock).ContainsKey(checkingTime) Then
                                ...
                                If checkPayload IsNot Nothing Then
                                    ...
                                    If highestATR <> Decimal.MinValue Then
                                        ...
                                        tempStockList.Add(runningStock, {Math.Round(range, 4), Math.Round(atrRange, 4), Math.Round(volumePerRange, 4), Math.Round(volSmaPer, 4), checkingTime.ToString("HH:mm:ss")})
                                    End If
                                End If
                            End If
                        Next
