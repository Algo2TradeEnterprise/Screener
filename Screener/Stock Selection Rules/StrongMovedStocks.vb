...
Public Class StrongMovedStocks
            ...
            While tradingDate <= endDate
                ...
                If atrStockList IsNot Nothing AndAlso atrStockList.Count > 0 Then
                    ...
                    For Each runningStock In atrStockList
                        ...
                        Dim movementPer As Decimal = ((runningStock.Value.PreviousDayClose - runningStock.Value.PreviousDayOpen) / runningStock.Value.PreviousDayOpen) * 100
                        If Math.Round(movementPer, 2) >= 5 Then
                            ...
                            row("Movement %") = Math.Round(movementPer, 2)
                            ret.Rows.Add(row)
