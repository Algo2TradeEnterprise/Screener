...
Partial Class frmStockSelection
    ...
    Private Sub InitializeComponent()
        ...
        Me.cmbProcedure.Items.AddRange(New Object() {"User Given", "ATR Based All Stock", "Pre Market Stock", "Intraday Volume Spike Stock", "OHL ATR Stock", "Touch Previous Day Last Candle", "Top Gainer Top Looser", "High Low Gap Stock", "Spot Future Arbritrage", "High Turnover Stock", "Top Gainer Top Looser Of Every Minute", "High Slab Level Moved Stocks", "Open At High Low", "Multi Timeframe Signal", "Narrow Range Stocks", "Top Gainer Losser of Every Slab", "CPR Narrow Range Stocks", "Lowest Range Stock Of Every Minute", "Lowest Range Stock Of X Minute", "Lower Price Options With Volume OI", "Lower Price Options With OI Change%", "Strong Moved Stocks", "Low ATR Candle Quick Entry Stocks", "EOD Low Range Stocks", "Previous Day Strong HK Stocks", "Volume Sort PreviousDayClose Filter CEPE Options", "Volume Sort PreviousDayClose Filter Top2 Options", "Volume Sort CurrentDayOpen Filter CEPE Options", "Volume Sort CurrentDayOpen Filter Top2 Options", "PreviousDayCloseATR Sort Volume Filter CEPE Options", "PreviousDayCloseATR Sort Volume Filter Top2 Options", "CurrentDayOpen ATR Sort Volume Filter CEPE Options", "CurrentDayOpen ATR Sort Volume Filter Top2 Options", "Lowest Price At The Money Options"})
